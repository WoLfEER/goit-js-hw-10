...
//Functions
function onSearch(e) {
  const querySearch = e.target.value.trim().toLowerCase();
  ...
  const markup = countries
    .map(
      country =>
        ...
        <img src="${country.flags.svg}" alt="Flag width = "50" height = "50" ${country.name.official}">
        <p>
...
function renderCountryInfo(countries) {
  ...
  " alt="Flag" width="120" ${countries[0].name.official}"/><b> ${
